...
class LaneDetector:
    ...
    def __init__(self):
        ...
        self.leftx_current, self.rightx_current = [150], [self.rightx_mid]
    ...
    def sliding_window(self, img, nwindows=7, margin=29, minpix=45, draw_windows=False):
        # 크기 3의 비어있는 배열 생성
    ...
    def process(self, origin_img):
        ...
        # cv2.putText(combined_img, 'Angle: {}'.format(curvature_angle), (0, 50), 1, 5, (255, 255, 255), 3)
        cv2.putText(combined_img, 'Angle: {}'.format(int(curvature_angle)), (0, 50), 1, 5, (255, 255, 255), 3)
        combined_img=cv2.line(combined_img,(70, 410), (120, 350),(0,255,0),5)
        combined_img=cv2.line(combined_img,(540, 350), (590, 410),(0,255,0),5)
        cv2.imshow('Lane', combined_img)
           #     vertices = np.array([(120, 480), (190, 370),
                            #        (500, 370), (550, 480)],
        # 주석 처리
